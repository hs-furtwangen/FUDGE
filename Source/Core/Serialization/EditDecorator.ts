namespace FudgeCore {
  ...
  export function edit<T extends String | Number | Boolean, P>(_collectionType: typeof Array, _valueType: abstract new (...args: General[]) => T): WrapperToPrimitve<T> extends P ? ((_value: unknown, _context: ClassPropertyDecoratorContext<object, Array<P> | ArrayLike<P> | Iterable<P>>) => void) : never;
  ...
  // object type array
  export function edit<T extends P, P>(_collectionType: typeof Array, _valueType: abstract new (...args: General[]) => T): (_value: unknown, _contex: ClassPropertyDecoratorContext<object, Array<P> | ArrayLike<P> | Iterable<P>>) => void; 
  ...
  // enum type array
  export function edit<E extends Record<keyof E, P>, P extends Number | String>(_collectionType: typeof Array, _valueType: E): (_value: unknown, _context: ClassPropertyDecoratorContext<object, Array<P> | ArrayLike<P> | Iterable<P>>) => void;
