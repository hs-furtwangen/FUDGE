namespace FudgeCore {
  export namespace AnimationSystem {
    export enum ANIMATION_CHANNEL_TYPE {
      BOOLEAN = "boolean",
      NUMBER = "number",
      STRING = "string",
      VECTOR = "vector",
    ...
    export class AnimationChannel {
      ...
      public type: ANIMATION_CHANNEL_TYPE;
      public interpolation: ANIMATION_INTERPOLATION;

      public constructor(_path: string, _times: Float32Array, _values: Float32Array, _type: ANIMATION_CHANNEL_TYPE, _interpolation: ANIMATION_INTERPOLATION) {
        this.path = _path;
        this.times = _times;
        this.values = _values;
        this.type = _type;
      ...
      public createInterpolant(): AnimationInterpolant {
        switch (this.interpolation) {
          ...
          case ANIMATION_INTERPOLATION.LINEAR:
            if (this.type === ANIMATION_CHANNEL_TYPE.QUATERNION)
