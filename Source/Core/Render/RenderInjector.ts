namespace FudgeCore {
  ...
  export class RenderInjector {
     ...
     */
    public static inject(_constructor: typeof Coat, _injector: typeof RenderInjector): void {
      ...
      Object.defineProperty(_constructor.prototype, Coat.prototype.useRenderData.name, {
        value: injection
      });
    }
  }
