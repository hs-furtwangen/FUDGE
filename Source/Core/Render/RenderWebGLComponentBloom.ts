  ...
  export class RenderWebGLComponentBloom {
    ...
    public static draw(_cmpBloom: ComponentBloom): void {
      ...
      for (let i: number = iterations - 1, divisor: number = 2 ** (iterations - 2); i > 0; i--, divisor /= 2) {
        ...
        // crc3.framebufferTexture2D(WebGL2RenderingContext.FRAMEBUFFER, WebGL2RenderingContext.COLOR_ATTACHMENT0, WebGL2RenderingContext.TEXTURE_2D, RenderWebGLComponentBloom.textures[i - 1], 0);
