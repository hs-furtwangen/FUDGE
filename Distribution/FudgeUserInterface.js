...
(function (FudgeUserInterface) {
    ...
    class Controller {
        ...
        static async save(_mutable, _mutator) {
            Controller.history.push([_mutable, _mutator]);
        }
        ;
        static async undo() {
            let undo = Controller.history.pop();
            if (undo)
