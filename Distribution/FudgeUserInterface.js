...
(function (FudgeUserInterface) {
    ...
    class Clipboard {
        ...
        get(_class = Object, _filter = true) {
            let result = this.objects.filter(_object => _object instanceof _class);
            return result;
        }
        clear() {
            this.objects = [];
