    ...
    class Controller {
        ...
        constructor(_mutable, _domElement) {
            ...
            this.refreshOptions = (_event) => {
                ...
                switch (action) {
                    case "assign":
                        const mutatorSelectOptions = ƒ.Metadata.assignOptions(mutable);
...
(function (FudgeUserInterface) {
    ...
    class Generator {
        ...
        static createInterfaceFromMutable(_mutable, _mutator) {
            ...
            const assignOptions = ƒ.Metadata.assignOptions(_mutable);
            const div = document.createElement("div");
            for (const key in mutator) {
                const element = Generator.createInterfaceElement(_mutable, mutator, key, types[key], createOptions[key], assignOptions[key]);
                if (!element)
                    continue;
        ...
        static createInterfaceFromArray(_mutable, _mutator, _parentMutable, _parentKey) {
            ...
            const getAssignOptions = ƒ.Metadata.assignOptions(_parentMutable)[_parentKey];
            const div = document.createElement("div");
        ...
        static createInterfaceElement(_mutable, _mutator, _key, _type, _getCreateOptions, _getAssignOptions, _parentMutable, _parentKey) {
            ...
            const forArray = Array.isArray(mutant);
            let element;
            if (forArray)
...
(function (FudgeUserInterface) {
    ...
    class Details extends HTMLDetailsElement {
        ...
        addPropertyMenu(_item) {
            ...
            const selectAssign = new FudgeUserInterface.CustomElementComboSelect({ key: "", type: type, action: "assign", placeholder: `🔍︎ Select object...` });
