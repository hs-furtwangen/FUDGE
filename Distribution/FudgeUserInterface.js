    ...
    class Generator {
        ...
        static createInterfaceElement(_mutable, _mutator, _key, _type, _descriptor, _parentMutable, _parentKey) {
            ...
            if (element) {
                ...
                const menu = Generator.createInterfaceElementMenu(typeName, !!_descriptor.getCreateOptions, !!_descriptor.getAssignOptions, _descriptor.kind != "function", true);
        ...
        static createInterfaceElementMenu(_type, _createOptions, _assignOptions, _creatable, _clearable) {
    ...
    class CustomElementInitializer extends FudgeUserInterface.CustomElement {
        ...
        connectedCallback() {
            ...
            if (createOptions || assignOptions) {
                let menu = FudgeUserInterface.Generator.createInterfaceElementMenu(this.getAttribute("type"), createOptions, assignOptions, false, false);
