    ...
    class Controller {
        constructor(_mutable, _domElement) {
            ...
            this.mutateOnInput = async (_event) => {
                ...
                console.log(mutator);
                this.domElement.dispatchEvent(new CustomEvent("saveHistory" /* EVENT.SAVE_HISTORY */, { bubbles: true, detail: {
