    ...
    class CustomTreeItem extends HTMLLIElement {
        ...
        constructor(_controller, _data) {
            ...
            this.hndDragOver = (_event) => {
                ...
                if (this.parentElement instanceof FudgeUserInterface.CustomTree || (offset > upper && (offset < lower || this.checkbox.checked)) || !this.controller.sortable) {
                    Reflect.set(_event, "dragProcessed", true);
