    ...
    class Generator {
        ...
        static createInterfaceElement(_mutable, _mutator, _key, _type, _descriptor, _parentMutable, _parentKey) {
            ...
            if (element) {
                ...
                const creatable = (element instanceof FudgeUserInterface.CustomElementInitializer) && _descriptor.kind != "function";
                const clearable = !(element instanceof FudgeUserInterface.CustomElementInitializer) && _descriptor.clearable;
