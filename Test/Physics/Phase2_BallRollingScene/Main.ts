...
namespace FudgePhysics_Communication {
  ...
  function init(_event: Event): void {
    ...
    let ground: f.Node = createCompleteMeshNode("Ground", new f.Material("Ground", f.ShaderFlat, new f.CoatRemissive(new f.Color(0.2, 0.2, 0.2, 1))), "Cube", 0, f.BODY_TYPE.STATIC, f.COLLISION_GROUP.GROUP_1);
  ...
  function createCompleteMeshNode(_name: string, _material: f.Material, _mesh: string, _mass: number, _physicsType: f.BODY_TYPE, _group: f.COLLISION_GROUP = f.COLLISION_GROUP.DEFAULT): f.Node {
